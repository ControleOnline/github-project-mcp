...
1. `https://github.com/ControleOnline/agents-mcp/blob/master/agents/agent/sysadmin/agent.md`
...
4. `https://github.com/ControleOnline/agents-mcp/blob/master/skills/agents/sysadmin/README.md`
